...
def _normalize_city_name(city: str) -> str:
    ...
    known_transforms = {
        ...
        # Multi-word cities with "Нова/Стара/Велика" prefix
        'нову миколаївку': 'Нова Миколаївка',
        'нову миколаївка': 'Нова Миколаївка',
        'стару миколаївку': 'Стара Миколаївка',
        'нову одесу': 'Нова Одеса',
        'нову каховку': 'Нова Каховка',
        'стару каховку': 'Стара Каховка',
        'нову прагу': 'Нова Прага',
        'стару прагу': 'Стара Прага',
        'нову ушицю': 'Нова Ушиця',
        'велику олександрівку': 'Велика Олександрівка',
        'малу олександрівку': 'Мала Олександрівка',
        'велику новосілку': 'Велика Новосілка',
        'нову маячку': 'Нова Маячка',
        'стару маячку': 'Стара Маячка',
    }
