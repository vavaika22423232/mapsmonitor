...
def format_bpla_message(city, region, prefix="БПЛА"):
    ...
    # Видаляємо зайві слова з міста
    city = city.strip()
    city = re.sub(r'^Район\s+', '', city, flags=re.IGNORECASE)  # "Район Новопокровка" -> "Новопокровка"
    city = re.sub(r'\s+р$', '', city)  # "Охтирський р" -> "Охтирський" (але це неправильно, треба "район")
    city = re.sub(r'\s+район$', '', city, flags=re.IGNORECASE)  # "Охтирський район" -> "Охтирський"
